                ...
                <div class="col-12 col-lg-10 col-xl-8">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-3 offset-1">
                            <a href="/assets" class="btn btn-white btn-block lift">
                                <span class="mt-8">&nbsp;</span>
                                <h1>View Asset</h1>
                            </a>
                        </div>
                        <div class="col-12 col-md-3">
                            <a href="/jobs" class="btn btn-white btn-block lift">
                                <span class="mt-8">&nbsp;</span>
                                <h1>Create Job</h1>
                            </a>
                        </div>
                        <div class="col-12 col-md-3">
                            <a href="/reports" class="btn btn-white btn-block lift">
                                <span class="mt-8">&nbsp;</span>
                                <h1>Reports</h1>
                            </a>
                        </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-4 offset-1 offset-2">
                            <a href="/movements" class="btn btn-white btn-block lift">
                                <span class="mt-8">&nbsp;</span>
                                <h1>Warehouse In</h1>
                            </a>
                        </div>
